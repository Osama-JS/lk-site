...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">تعديل: {{ $page->title_ar }}</li>
@endsection
        ...
        <div class="col-md-10">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title fw-bold mb-0">تحديث بيانات الصفحة</h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2">
                                @if($page->image)
                                    <img id="page-preview" src="{{ asset('storage/' . $page->image) }}" alt="Preview" style="max-width: 200px; border-radius: 8px;">
                                @else
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select">
                                    <option value="published" {{ $page->status == 'published' ? 'selected' : '' }}>منشور</option>
                        ...
                        <div class="d-flex justify-content-end gap-2 border-top pt-3">
                            ...
                            <button type="submit" class="btn btn-primary-custom px-4">
                                <i class="fas fa-save me-1"></i> تحديث الصفحة
                            </button>
                        </div>
                    </form>
                </div>
